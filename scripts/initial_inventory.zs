...
//
// Layout:
//   0: Traveler's Companion (Patchouli book — patchouli:travelers_companion) — spawns in hand
//   1: [empty]
//   2: [empty]
//   3: [empty]
//   4: [empty]
...
//   2026-06-28 — Companion to slot 0 (spawns in hand); removed Materials and You (Tinkers book)

import mods.initialinventory.InvHandler;

InvHandler.addStartingItem("default", <item:patchouli:guide_book>.withTag({"patchouli:book": "patchouli:travelers_companion"}), 0);
